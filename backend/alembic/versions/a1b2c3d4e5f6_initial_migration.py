...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('latitude', sa.Float(), nullable=False),
        sa.Column('longitude', sa.Float(), nullable=False),
        sa.Column('grid_hash', sa.String(length=20), nullable=False),
        ...
        sa.Column('safe_place_count', sa.Integer(), nullable=False, server_default='0'),
        sa.Column('time_period', sa.String(length=20), nullable=False, server_default='all'),
        ...
        sa.Column('police_proximity', sa.Float(), nullable=True),
        ...
        sa.Column('is_deleted', sa.Boolean(), nullable=False, server_default='false'),
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint('grid_hash')
    )
    op.create_index('ix_safety_heatmaps_grid_hash', 'safety_heatmaps', ['grid_hash'], unique=False)
    ...
    op.create_table(
        ...
        sa.Column('officer_in_charge', sa.String(length=100), nullable=True),
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
        sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
        sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True),
        sa.Column('is_deleted', sa.Boolean(), nullable=False, server_default='false'),
    ...
    op.create_table(
        ...
        sa.Column('has_emergency_ward', sa.Boolean(), nullable=False, server_default='true'),
